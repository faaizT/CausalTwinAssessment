...
def main(args):
    ...
    for i in tqdm(range(run_no*episodes, (run_no+1)*episodes)):
        ...
        while not done:
            ...
            t += 1
    df.to_csv(f"{args.output_dir}/Cartpole-v1-obs-data-run{run_no}-ep{episodes}.csv", index=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="/data/localhost/taufiq/export-dir/cartpole-models/obs-pol-state",
    )
    parser.add_argument(
        "--output_dir",
        help="Directory to save data in",
        type=str, 
        default="/data/localhost/taufiq/export-dir"
    )
